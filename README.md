...
AI ChatWorks is a comprehensive browser extension designed to supercharge AI chatbot workflows. It provides a powerful prompt library, a quick-access command palette, and best-in-class text direction support, transforming how you interact with leading AI platforms.

### **Core Problem Solved**

Modern AI chatbots lack efficient tools for managing, reusing, and quickly accessing prompts. Workflows are often repetitive, and users working with Right-to-Left (RTL) languages like Hebrew or Arabic face a frustrating experience with misaligned text.

AI ChatWorks solves these problems by providing a centralized **Prompt Library**, a "Spotlight-style" **Flow** command palette for quick actions, and intelligent, automatic **Text-Direction Control**.

### **Key Features**

#### **1. The Ultimate Prompt Library**
...
#### **2. AI ChatWorks Flow (Command Palette)**

* **Instant Access:** Press Cmd+J (Mac) or Ctrl+J (Windows) to open a Spotlight-style command palette.  
* **Quick Search:** Instantly search your entire prompt library without leaving the keyboard.  
* **Quick Actions:** Create new prompts, summarize the current chat, open settings, or create folders all from one interface.

#### **3. Intelligent Text Direction**
...
* Install the extension directly from the [Chrome Web Store](https://www.google.com/search?q=link-to-your-store-page).
...
* **NEW:** **Summarize Chat** - Auto-copy summary to clipboard with progress feedback.  
* **NEW:** **Language Detection** - Summaries adapt to conversation language with localized section headers.  
* **NEW:** **Full Fidelity Summaries** - Enhanced 7-section summary structure with reasoning and context.  
* **IMPROVEMENT:** **Flow UX** - Better spacing for prompt icons, smoother animations.  
* **IMPROVEMENT:** **Favorite Animation** - Visual feedback when marking prompts as favorite.  
* **FIX:** **Dark Mode** - Sort dropdown now displays correctly in dark theme.  
* **FIX:** **Collapse Animations** - Significantly slower, smoother transitions for sidebar and folder list.
